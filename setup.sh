...
# Install Python package + torch (always runs — packages live on container disk, not persistent volume)
...
# Install system dependencies (always runs — lives on container disk)
