...
const ServersInfoSchema = z.object({
  ...
  mimi_model_file: z.string().optional(),
  instance_name: z.string(),
  retrieval_backends: z
    .array(z.object({ id: z.string()}))
    .optional(),
  retrieval_backend_default: z.string().optional(),
  build_info: z.object({
...
type ServerInfo = {
  ...
  retrieval_backends?: { id: string }[];
  retrieval_backend_default?: string;
  build_info: {
